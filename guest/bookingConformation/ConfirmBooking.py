...
"background-color: rgb(111, 111, 111);")
        ...
        self.Ticketconfirmationarea.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        ...
        self.TotalPriceLabel.setStyleSheet("color: rgb(238, 238, 238);")
        self.TotalPriceLabel.setObjectName("TotalPriceLabel")
        self.TotalPriceDisplay = QtWidgets.QLabel(self.CustomerDetailsFrame)
        self.TotalPriceDisplay.setGeometry(QtCore.QRect(100, 220, 291, 31))
        self.TotalPriceDisplay.setStyleSheet("color: rgb(238, 238, 238);")
        self.TotalPriceDisplay.setFrameShape(QtWidgets.QFrame.Box)
        self.TotalPriceDisplay.setLineWidth(2)
        self.TotalPriceDisplay.setText("")
        self.TotalPriceDisplay.setObjectName("TotalPriceDisplay")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.TotalPriceLabel.setText(_translate("Dialog", "Total Price:"))
